...
<head>
  ...
  <title>VendettaMafia Terminal</title>
  <style>
    html, body {
      margin: 0;
      padding: 0;
    ...
    @media (max-width: 600px) {
      ...
      .message, .terminal, .signature { font-size: 0.9em; }
    }
  </style>
</head>
<body>
  ...
  <div class="box" id="galaxy-box">
    <img class="logo" src="https://ibb.co/849wcPCH" alt="M0r404.logo" />
    <h1>GREETINGS WORLD</h1>
    <div class="signature">
      Hacked By <strong>M0r404</strong> aka <strong>M0r404</strong><br>
      <em>m0r404washere@gmail.com • wopss LOL</em>
    </div>
    <div class="terminal">
root@M0r403:/# injecting payload...<br>
target response: 200 OK<br>
payload status: <span style="color:#00ff88;">executed</span><br>
compromised system: <strong style="color:#ff0040;">Fuck Your Website</strong>
    </div>
  ...
  <script>
    const text = `
We are CYBERCRIME INTERNATIONAL.
